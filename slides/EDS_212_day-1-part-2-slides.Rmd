...
## Day 1 data science vocabulary

- **GUI**: Stands for *graphical user interface*. An interface for communicating with your computer that uses buttons & icons (point & click options) instead of or in addition to text/command based instructions to do stuff. 

- **Edge case:** an issue or scenario that occurs in rare/unexpected circumstances (opposite of a general case).

- **Bork:** mess up, break something, really do a number on your code. Often used in a self-deprecating statement, like "Don't mind me over here, just borking my git branch to smithereens."
