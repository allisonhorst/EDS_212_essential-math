...
![Schematic of basic git solo user workflow.](images/git_bunnies_1.jpg)
...
-   In your .Rmd, make some changes (whatever you want). Save. Knit (or not...as long as one file changes).

-   Notice that in the git tab in RStudio, the file(s) you updated show up as having been updated.

-   Stage (check box next to files), Commit (add commit message), Pull (for habit), then Push to the remote repo. Go to your remote repo on GitHub. Let's check out some changes!
