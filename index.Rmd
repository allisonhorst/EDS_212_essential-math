...
-   [Course syllabus](https://docs.google.com/document/d/1F0JJTEqipjKNn0WMPqABoPIcds7zMJGoz1jinGwUcpU/edit?usp=sharing)
...
**Course dates:** Monday (2021-08-01) - Friday (2021-08-05)

EDS 212 is an intensive 1-week long 2-unit course. Students should plan to attend all scheduled sessions. All course requirements will be completed between 9am and 4:30pm PT (M - F), i.e. you are not expected to do additional work for EDS 212 outside of those hours, unless you are working with the Teaching Assistant in student hours.

::: {style="color: teal;"}
***Note:** For EDS 212 and 221, we will start Wednesdays at 10:00am (instead of 9:00am).*
:::
...
| 11:00am - 12:00pm | *Flex time (60 min)*             |
| 12:00pm - 1:00pm  | *Lunch (60 min)*                 |
| 1:00pm - 2:00pm   | *Lecture 2 (60 min)*             |
...
| 1 (afternoon) | [Functions (interpreting & evaluating), reading graphs, slope](slides/EDS_212_day-1-part-2-slides.html)                                                                                                              | By hand practice problems; [R projects, storing objects, creating vectors and sequences](comp_session_keys/comp_session_1b.html) | *none*                                       | [Day 1 Tasks - Handout](activities/day_1_activities.html) |
| 2 (morning)   | [Definition of the derivative](slides/EDS_212_day-2-part-1-slides.html)                                                                                                                                              | [Derivatives by hand and in R](comp_session_keys/comp_session_2a.html)                                                           | git and GitHub continued                     |                                                           |
| 2 (afternoon) | [Higher order & partial derivatives](slides/EDS_212_day-2-part-2-slides.html)                                                                                                                                        | [Partial & higher order derivatives in R](comp_session_keys/comp_session_2b.html)                                                | *none*                                       | [Day 2 Tasks - Handout](activities/day_2_activities.html) |
...
| 3 (afternoon) | [Introduction to linear algebra basics](slides/EDS_212_day-3-part-2-slides.html)                                                                                                                                     | [Making & basic algebra with vectors and matrices](comp_session_keys/comp_session_3b.html)                                       | *No flex sessions Wednesday - late start*    | [Day 3 Tasks - Handout](activities/day_3_activities.html) |
| 4 (morning)   | [Linear algebra continued](slides/EDS_212_day-4-part-1-slides.html)                                                                                                                                                  | [Linear algebra continued - vectors, matrices, a Leslie matrix example](comp_session_keys/comp_session_4a.html)                  | Data Science Communities - Panel             |                                                           |
...
| 5 (morning)   | Summary statistics continued, [basic probability theory](slides/EDS_212_day-5-part-1-slides.html)                                                                                                                    | Basic probability problems, [summary statistics, R Markdown customization](comp_session_keys/comp_session_5a.html)               | Start building your personal website w/ Sam! |                                                           |
