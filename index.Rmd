...
| Day | Session : Topic                                                            |
+=====+============================================================================+
| 1   | A: Basic algebra review, units and unit conversions, exponents, logarithms |
|     |                                                                            |
|     | B: Functions (interpreting & evaluating), reading graphs, slope            |
+-----+----------------------------------------------------------------------------+
| 2   | A: Definition of the derivative                                            |
|     |                                                                            |
|     | B: Higher order & partial derivatives                                      |
+-----+----------------------------------------------------------------------------+
| 3   | A: Differential equations, and solving them numerically                    |
|     |                                                                            |
|     | B: Introduction to linear algebra basics                                   |
+-----+----------------------------------------------------------------------------+
| 4   | A: Linear algebra continued                                                |
|     |                                                                            |
|     | B: Essential summary statistics and describing data                        |
+-----+----------------------------------------------------------------------------+
| 5   | A: Basic probability theory                                                |
|     |                                                                            |
|     | B: Boolean algebra and logical operations                                  |
+-----+----------------------------------------------------------------------------+
