...
Let's say that we have a differential equation $\frac{dx}{dt}=2x$, and we don't know how to solve analytically for $x(t)$. Using the initial condition $x(0)=1$, let's numerically estimate the solution.
