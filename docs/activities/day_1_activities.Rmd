...
1.  Simplify the following: $2-\frac{3*6-12}{3}*2-4^2(3^2-7)$

2.  Simplify the following: $3x(4x^2-2)-\frac{6x(2x+1)}{3x}$

### Evaluate the following:

3.  Evaluate $f(x,y)=x^2-1+3xy$ at $x=1$ and $y = 0$

4.  Given $G(t,z)=3.1(t-4.2)^2 + 0.06z$, find the value of $G(1, 2.5)$

5.  Evaluate $T(a)=3a^2-4$ at $a = x + \Delta x$
...
If the units of force ($F$) are in Newtons ($\frac{kg \cdot m}{s^2}$), what are the units of the gravitational constant?
...
$$P(t)=567+4.1e^{0.11t}$$ a) What are the units of 567? b) What are the units of 0.11? c) What is the estimated population at t = 24 months?
...
What is the total *unrecovered* amount of oil spilled into the watershed that year, in barrels?
