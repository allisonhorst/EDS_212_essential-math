...
- Create a new version-controlled Quarto project (you may want to name it `eds212_day3_task2` or something similar)

- Create a new .qmd within your project
...
- Fork and clone [this repo](https://github.com/allisonhorst/eds212-sir-ode), which contains an R Markdown document with code to numerically solve the SIR equations, to create a version-controlled Quarto project
